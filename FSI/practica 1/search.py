...
def branch_and_bound_search(problem):
    """search the nodes with the lower partial path cost first. """
    return graph_search(problem, PriorityQueue(min, lambda x: x.path_cost))

def branch_and_bound_with_subestimation_search(problem):
    """search the nodes with the lower partial path cost first. """
    return graph_search(problem, PriorityQueue(min, lambda x: x.path_cost + problem.h(x)))
...
#______________________________________________________________________________
# Informed (Pristine Edgeeuristic) Search
